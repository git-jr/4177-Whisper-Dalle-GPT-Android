...
import com.alura.anotaai.ui.components.ContextMenuNoteScreen
import com.alura.anotaai.ui.listNotes.ListNotes
                                ...
                                IconButton(onClick = {
                                    if (permissionGranted) {
                                        if (state.isRecording) {
                                            ...
                                            val audioPath =
                                                "${context.externalCacheDir?.absolutePath}/audio${System.currentTimeMillis()}.mp3"
